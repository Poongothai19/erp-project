...
// Cognifyar Credentials provided
const CLIENT_ID = '86ie862ly62eu3';
const CLIENT_SECRET = 'WPL_AP1.jJfumBvpsGxUb3Dp.P9+5oA==';
...
app.get('/callback', async (req, res) => {
    ...
    try {
        ...
        console.log('\n================ SUCCESS ================');
        console.log('Here is your Cognifyar Access Token:\n');
...
app.listen(port, () => {
    console.log(`\n=== LinkedIn Token Generator for Cognifyar ===`);
    console.log(`Waiting for authorization...`);
    console.log(`\nACTION REQUIRED BEFORE PROCEEDING:`);
    console.log(`1. Go to your LinkedIn Developer Portal (Auth Tab) for the Cognifyar app.`);
