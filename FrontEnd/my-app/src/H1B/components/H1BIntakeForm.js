...
import logo from "../../Recruitment/Assets/images/prophecy-logo.png";
import logo2 from "../../Recruitment/Assets/images/prophecy-logo2.png";
import { 
  FaCheck, 
  FaCircle, 
  FaTimes, 
...
function Card({ title, children }) {
  return (
    <section className="h1b-card">
      <h2 className="h1b-section-title">{title}</h2>
      {children}
    </section>
  );
}

export default function H1BIntakeForm() {
  ...
  const [form, setForm] = useState({
    employer_name: "Prophecy Technologies",
    filing_type: "",
...
const submit = async (e) => {
  ...
  return (
    <div className="h1b-container">
      {/* Navigation Bar */}
      <header className="h1b-header">
        <div className="h1b-container-inner">
          <div
            style={{
              display: "flex",
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div>
                <div style={{ marginBottom: "4px", display: "flex", alignItems: "center", gap: "2px" }}>
                  <img src={logo2} alt="Prophecy Technologies Icon" style={{ height: "40px", objectFit: "contain" }} />
                  <img src={logo} alt="Prophecy Technologies Logo" style={{ height: "40px", objectFit: "contain" }} />
                </div>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <a 
                  href="mailto:notifications@prophecytechs.com" 
                  style={{ 
                    fontSize: 12, 
                    color: "white", 
                    textDecoration: "none",
                ...
                >
                  notifications@prophecytechs.com
                </a>
              </div>
            </div>
          </div>
        ...
        {!showSuccess && (
          <>
            ...
            <Card title="Employee Personal Information">
              <div className="h1b-grid" style={{ gridTemplateColumns: "100px 1fr 1fr 1fr" }}>
                <div className="h1b-form-group">
                  <label className="h1b-label">Prefix</label>
                  <select
                    className="h1b-select"
                    value={form.prefix}
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label h1b-required">First Name</label>
                  <input
                    className="h1b-input"
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label">Middle Name</label>
                  <input
                    className="h1b-input"
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label h1b-required">Last Name</label>
                  <input
                    className="h1b-input"
              ...
              <div className="h1b-grid" style={{ marginTop: 8 }}>
                <div className="h1b-form-group">
                  <label className="h1b-label">Gender</label>
                  <select
                    className="h1b-select"
                    value={form.gender}
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label">Passport No.</label>
                  <input
                    className="h1b-input"
              ...
              <div className="h1b-grid" style={{ marginTop: 8 }}>
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label">Nationality</label>
                  <input
                    className="h1b-input"
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label">Country of Birth</label>
                  <input
                    className="h1b-input"
              ...
              <div className="h1b-grid" style={{ marginTop: 8 }}>
                <div className="h1b-form-group">
                  <label className="h1b-label">Place of Birth (City)</label>
                  <input
                    className="h1b-input"
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label">Phone Number</label>
                  <input
                    className="h1b-input"
                    value={form.phone}
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label h1b-required">Email</label>
                  <input
                    className="h1b-input"
                    type="email"
                    value={form.email}
            ...
            <Card title="Immigration Status">
              <div className="h1b-grid">
                <div className="h1b-form-group">
                  <label className="h1b-label h1b-required">
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label">Type of Filing</label>
                  <select
                    className="h1b-select"
            ...
            <Card title="Education">
              ...
              <div className="h1b-grid" style={{ marginTop: 12 }}>
                <div className="h1b-form-group">
                  <label className="h1b-label">Master's Degree</label>
                  <input
                    className="h1b-input"
            ...
            <Card title="Employment Details (if applicable)">
              <div className="h1b-grid">
                <div className="h1b-form-group">
                  <label className="h1b-label">Job Title</label>
                  <input
                    className="h1b-input"
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label">Expected Salary</label>
                  <input
                    className="h1b-input"
              ...
              <div style={{ marginTop: 12 }}>
                <label className="h1b-label">Job Duties / Summary</label>
                <textarea
                  className="h1b-textarea"
                  style={
                    focusedField === "job_summary"
                      ? {
                          borderColor: "rgba(2, 126, 240, 1)",
                          boxShadow: "0 0 0 3px rgba(2, 126, 240, 0.1)",
                        }
                      : {}
                  }
              ...
              <div style={{ marginTop: 12 }}>
                <label className="h1b-label">Worksite Address</label>
                <textarea
                  className="h1b-textarea"
                  style={{
                    minHeight: "70px",
              ...
              <div style={{ marginTop: 12 }}>
                <label className="h1b-label">Home Address</label>
                <textarea
                  className="h1b-textarea"
                  style={{
                    minHeight: "70px",
            ...
            <Card title="Client & Vendor Chain">
              <div className="h1b-grid">
                <div className="h1b-form-group">
                  <label className="h1b-label">End Client</label>
                  <input
                    className="h1b-input"
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label">Tier 1 Vendor</label>
                  <input
                    className="h1b-input"
              ...
              <div className="h1b-grid" style={{ marginTop: 12 }}>
                <div className="h1b-form-group">
                  <label className="h1b-label">Tier 2 Vendor</label>
                  <input
                    className="h1b-input"
                ...
                <div className="h1b-form-group">
                  <label className="h1b-label">Tier 3 Vendor</label>
                  <input
                    className="h1b-input"
            ...
            <Card title="Consent & Final Submission">
              <div style={{ marginBottom: 14 }}>
                <label className="h1b-checkbox-label">
                  <input
                    type="checkbox"
                    className="h1b-checkbox"
              ...
              <div className="h1b-action-buttons">
                <button
                  className="h1b-button-primary"
                  disabled={busy}
                  onClick={submit}
              ...
              {/* 
              <div className="h1b-debug-info" style={{ marginTop: 12 }}>
                <div className="h1b-debug-title">Application Progress:</div>
                <div>
                  • Personal Info:{" "}
                  {form.first_name && form.last_name
                    ? "✓ Complete"
