...
import logo from "../../Recruitment/Assets/images/DISENAILOGO (1).png";
import { 
  FaCheck, 
  FaCircle, 
  FaTimes, 
...
export default function DisensystemH1BIntakeForm() {
...
const submit = async (e) => {
  ...
  return (
    <div className="h1b-container" style={{ background: 'linear-gradient(180deg, #061124 0%, #030814 100%)' }}>
      {/* Navigation Bar */}
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div>
                <div style={{ marginBottom: "4px", display: "flex", alignItems: "center", gap: "2px" }}>
                  <img src={logo} alt="Disensystem Logo" style={{ height: "40px", objectFit: "contain" }} />
                </div>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <a 
                  href="mailto:onboarding@disensystems.com" 
                  style={{ 
                    fontSize: 12, 
                    color: "white", 
                    textDecoration: "none",
                ...
                >
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 4 }}>
                      ...
                      <div>
                        <strong>Disensystem application deadline:</strong> Submit
